...
TEST_VM(moveBits, reversals) {
  test_reversals<int64_t>();
  test_reversals<uint64_t>();
  test_reversals<int32_t>();
  test_reversals<uint32_t>();
  test_reversals<int16_t>();
  test_reversals<uint16_t>();
  test_reversals<int8_t>();
