...
#define RUNTIME_FLAGS(develop,                                              \
  ...
  product(ccstr, TrainingFile, nullptr,                                     \
          "If Training or Deploying is enabled, store or load VM training " \
          "data to or from this file [default: ./hs_training_%p.log] "      \
          "(%p replaced with pidNNN on output, empty string on input)")     \
                                                                            \
